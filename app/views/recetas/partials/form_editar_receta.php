...
<form method="post" action="" id="frm" role="form">
   <?= FH::inputBlock('hidden', 'prod_id *', 'prod_id', $this->datos[0]->prod_id, ['class' => 'form-control'], ['class' => 'd-none form-group col-md-4'], []) ?>
   <div class="row">
      <div class="col-md-4">
      ...
      <?= FH::inputBlock('number', 'Porcentaje *', 'porcentaje', '', ['class' => 'form-control w-100'], ['class' => 'form-group col-md-2 form-inline'], []) ?>
         ...
         <table id="tablaRecetas" class="table table-striped table-condensed table-bordered table-hover">
            ...
            <tbody>
               <?php foreach ($this->datos as $datos) : ?>
                  <tr>
                     <td data-mp="<?= $datos->mp_id; ?>"><?= $datos->materia_prima; ?></td>
                     <td data-porce="<?= $datos->porcentaje; ?>"><?= $datos->porcentaje; ?></td>
                     <td>
                        <div class="row">
                           <div class="col">
